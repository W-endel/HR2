                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control text-dark" id="first_name" name="first_name" value="<?php echo htmlspecialchars($employeeInfo['firstname']); ?>" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="last_name" class="text-light">Last Name:</label>
                                        <input type="text" class="form-control text-dark" id="last_name" name="last_name" value="<?php echo htmlspecialchars($employeeInfo['lastname']); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control text-dark" id="role" name="role" value="<?php echo htmlspecialchars($employeeInfo['role']); ?>" readonly>
                                    </div>
                                    <div class="col-md-6">
