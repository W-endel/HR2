...
if (isset($_POST['resend_token'])) {
    ...
    try {
        ...
        $resetLink = "http://localhost/HR2/e_portal/e_reset_password.php?token=$newToken"; // Update the URL with the new token
        $mail->isHTML(true);
                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5 bg-dark">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mt-3 mb-0">
                            <a class="btn border-secondary w-100 text-light border border-1" href="../e_portal/employee_login.php">Back</a>
                        </div>
                    </div>
                </div>
            </div>
