...
// Fetch employee records where role is 'employee' and department is 'credit'
$sql = "SELECT e_id, firstname, lastname, role, position FROM employee_register WHERE role = 'employee' AND department = 'Credit Department'";
...
<body class="bg-dark text-light">
    <div class="container mt-5">
        <h2 class="text-center text-primary mb-4">Credit Department Employee Evaluation</h2>
    ...
    // Pass the department value (Credit Department in this case)
    const department = 'Credit Department'; 

    $.ajax({
        type: 'POST',
        url: '../db/submit_credit.php',
        data: {
