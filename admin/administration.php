                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-success" 
                                        onclick="evaluateEmployee(<?php echo $employee['employeemployee_id']; ?>, '<?php echo htmlspecialchars($employee['firstname'] . ' ' . $employee['lastname']); ?>', '<?php echo htmlspecialchars($employee['position']); ?>')"
