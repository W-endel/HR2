    ...
    if ($action_result->num_rows > 0) {
        ...
        if ($status === 'approve') {
            ...
            if ($leave_days > $available_leaves) {
                ...
                header("Location: leave_requests.php?status=insufficient_balance");
                exit();
            } else {
                ...
                if ($update_stmt->execute()) {
                    header("Location: leave_requests.php?status=success");
                } else {
        ...
        header("Location: leave_requests.php?status=not_exist");
    }
    exit();
}
?>
        ...
        <main>
            <div class="container-fluid position-relative px-4">
                ...
                <div class="container py-4">
                    ...
                    <table class="table table-bordered mt-3 text-center text-light table-dark mx-auto"> 
                        <thead>
                            <tr>
                                <th>Employee ID</th>
                                <th>Employee Name</th>
