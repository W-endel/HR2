...
$sql = "SELECT firstname, lastname, department, role, position FROM registeradmin_db WHERE role = 'employee' AND department = 'Operations Department'";
...
if ($result->num_rows > 0) {
    ...
    echo "No employee records found for Operations Department.";
}
...
<body>
    <h2>Operations Department Employee Evaluation</h2>
    <table>
        <thead>
            <tr>
                <th>Full Name</th>
