                            ...
                            <div class="card-body bg-dark">
                                <form id="infoForm" action="../main/update_profile.php" method="post">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <button type="submit" class="btn btn-secondary border border-light d-none w-30">Save Changes</button>
                                        <button type="button" id="editButton" class="btn btn-secondary border border-light w-30">Update Information</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end mb-2"> <a class="btn border-secondary w-30 text-light" href="../main/index.php">Back</a></div>
                    </div>
                </div>
            </div>
        </main>
