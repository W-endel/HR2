                            ...
                            <div class="card-body bg-dark">
                                <form id="infoForm" action="../main/update_profile.php" method="post">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="button" id="editButton" class="btn btn-primary border border-light w-30">Update Information</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <a href="../main/change_pass.php" class="btn btn-primary">Change Password</a>
                    </div>
                </div>
            </div>
        </main>
