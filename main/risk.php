...
$sql = "SELECT firstname, lastname, department, role, position FROM registeradmin_db WHERE role = 'employee' AND department = 'Risk Management Department'";
...
if ($result->num_rows > 0) {
    ...
    echo "No employee records found for Risk Management Department.";
}
...
<body>
    <h2>Risk Management Department Employee Evaluation</h2>
    <table>
        <thead>
            <tr>
                <th>Full Name</th>
        ...
        <tbody>
            <?php if (!empty($employees)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <tr><td colspan="4">No employees found for evaluation in Risk Management Department.</td></tr>
            <?php endif; ?>
        </tbody>
    </table>
