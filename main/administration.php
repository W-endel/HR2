...
// Fetch employee records where role is 'employee' and department is 'administration'
$sql = "SELECT e_id, firstname, lastname, role, position FROM employee_register WHERE role = 'employee' AND department = 'Administration Department'";
...
<body class="bg-dark text-light">
    <div class="container mt-5">
        <h2 class="text-center text-primary mb-4">Administration Department Employee Evaluation</h2>
    ...
    // Pass the department value (Administration Department in this case)
    const department = 'Administration Department'; 

    $.ajax({
        type: 'POST',
        url: '../db/submit_administration.php',
        data: {
