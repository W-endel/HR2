            ...
            <div class="container-fluid px-4">
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-4 col-md-6 mt-5">
                        <div class="card mb-4">
                            <div class="card-body bg-primary text-center">
                                <a href="../main/administration.php" class="btn card-button text-dark font-weight-bold bg-light border border-dark w-100">Administration Department</a>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6 mt-5">
                        <div class="card mb-4">
                            <div class="card-body bg-primary text-center">
                                <a href="../main/sales.php" class="btn card-button text-dark font-weight-bold bg-light border border-dark w-100">Sales Department</a>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6 mt-5">
                        <div class="card mb-4">
                            <div class="card-body bg-primary text-center">
                                <a href="../main/credit.php" class="btn card-button text-dark font-weight-bold bg-light border border-dark w-100">Credit Department</a>
                            </div>
