...
// Fetch employee records where role is 'employee' and department is 'IT'
$sql = "SELECT e_id, firstname, lastname, role, position FROM employee_register WHERE role = 'employee' AND department = 'IT Department'";
...
<body class="bg-dark text-light">
    <div class="container mt-5">
        <h2 class="text-center text-primary mb-4">IT Department Employee Evaluation</h2>
    ...
    // Pass the department value (IT Department in this case)
