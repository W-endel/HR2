...
$sql = "SELECT employee_id, first_name, last_name, role, position 
        FROM employee_register 
        WHERE position = ? AND department = ? AND role IN ('supervisor', 'contractual')";
$stmt = $conn->prepare($sql);
...
<body class="sb-nav-fixed">
                    ...
                    <div class="employee-table-container">
                        <div class="employee-table-header">
                            <h5 class="mb-0">
                                ...
                                <?php echo htmlspecialchars($department); ?> Employees
                            </h5>
    ...
    <script>
        ...
        function submitEvaluation() {
            ...
            $.ajax({
                type: 'POST',
                url: '../../employee_db/contractual/submit_evaluation.php',
                data: {
