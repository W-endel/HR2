...
<style>
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark border-bottom border-1 border-secondary">
        <a class="navbar-brand d-none d-md-inline-block form-inline ps-3 text-muted" href="../../employee/fieldworker/dashboard.php">Employee Portal</a>
    ...
    <script>
        ...
        const features = [
            ...
            { name: "Timesheet", link: "../../employee/fieldworker/timesheet.php", path: "Time and Attendance/Attendance Timesheet" },
            { name: "Evaluation", link: "../../employee/fieldworker/evaluation.php", path: "Performance Management/Evaluation Ratings" },
            { name: "Perfroamnce Rating", link: "../../employee/fieldworker/Performance Rating.php", path: "Performance Management/Performance Rating" },
            { name: "Awardee", link: "../../employee/fieldworker/awardee.php", path: "Social Recognition/Awardee" },
            { name: "Profile", link: "../../employee/fieldworker/profile.php", path: "Profile" },
        ];
