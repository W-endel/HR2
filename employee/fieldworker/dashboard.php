                            ...
                            <div class="card bg-dark text-light" style="height: 500px;">
                                ...
                                <div class="card-body overflow-auto" style="max-height: 400px;">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="mb-2">
                                            <h5 class="fw-bold d-inline">Today's Date: <a href="../../employee/fieldworker/dashboard.php" 
                        ...
                        <div class="col-md-6 mt-2 mb-2">
                            <div class="card bg-dark">
                                <div class="card-header text-light border-bottom border-1 border-secondary">
                                    ...
                                    <a class="text-light" href="../../employee/fieldworker/performance_rating.php">Performance Ratings</a>
                                </div>
                        ...
                        <div class="col-md-12 mt-2 mb-2">
                            <div class="card bg-dark text-light border-0">
                                <div class="card-header border-bottom border-1 border-secondary">
                                    ...
                                    <a class="text-light" href="../../employee/fieldworker/awardee.php">Top Performers</a>
                                </div>
                                <div class="card-body">
...
async function fetchAttendance(month, year) {
    try {
        const response = await fetch(`/HR2/employee_db/fieldworker/fetch_attendance.php?employee_id=${employeeId}&month=${month + 1}&year=${year}`);
...
async function showAttendanceDetails(day) {
    ...
    const leaveResponse = await fetch(`/HR2/employee_db/fieldworker/fetch_leave.php?employee_id=${employeeId}&day=${day}&month=${currentMonth + 1}&year=${currentYear}`);
    ...
    if (leaveData.onLeave) {
        ...
        const attendanceResponse = await fetch(`/HR2/employee_db/fieldworker/fetch_attendance.php?employee_id=${employeeId}&day=${day}&month=${currentMonth + 1}&year=${currentYear}`);
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('../../employee_db/fieldworker/top_performers.php')
