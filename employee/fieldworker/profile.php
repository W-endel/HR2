...
<body class="sb-nav-fixed bg-black">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-lg-3 text-center" style="margin-top: -75px; padding: 0 2rem;">
                                            ...
                                            <div class="d-grid gap-2 mb-4">
                                                ...
                                                <a href="../../employee/fieldworker/change_pass.php" class="btn btn-outline-primary btn-icon">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form id="infoForm" action="/HR2/employee_db/fieldworker/update_profile.php" method="post">
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                <div class="form-label-group">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/HR2/employee_db/fieldworker/delete_employee_pfp.php" method="post">
    ...
    <form action="/HR2/employee_db/fieldworker/update_employee_pfp.php" method="post" enctype="multipart/form-data" id="profilePictureForm" style="display:none;">
