                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseTAD" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link text-light loading " href="../../employee/contractual/timesheet.php">
                                    <i class="fas fa-clock me-2"> </i>Timesheet</a>
                            </nav> 
                        </div>
                        ...
                        <div class="collapse" id="collapsePM" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link text-light loading" href="../../employee/contractual/performance_rating.php">
                                    <i class="fas fa-bar-chart me-2"></i> Performance Rating</a>
                                <a class="nav-link text-light loading" href="../../employee/contractual/evaluation.php">
                                    <i class="fas fa-users me-2"></i> Evaluation</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseSR" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link text-light loading" href="../../employee/contractual/awardee.php">
                                    <i class="fa fa-trophy me-2"></i> Awardee</a>
                            </nav>
                        </div> 
                    </div>
                </div>
