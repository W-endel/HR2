...
<style>
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark border-bottom border-1 border-secondary">
        <a class="navbar-brand d-none d-md-inline-block form-inline ps-3 text-muted" href="../../employee/staffr/dashboard.php">Employee Portal</a>
    ...
    <script>
        ...
        const features = [
            ...
            { name: "Timesheet", link: "../../employee/staff/timesheet.php", path: "Time and Attendance/Attendance Timesheet" },
            { name: "File Leave", link: "../../employee/staff/leave_file.php", path: "Leave Management/File Leave" },
            { name: "Evaluation", link: "../../employee/staff/evaluation.php", path: "Performance Management/Evaluation Ratings" },
            { name: "Perfroamnce Rating", link: "../../employee/staff/performance_rating.php", path: "Performance Management/Performance Rating" },
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function fetchNotifications() {
                fetch('../../employee_db/fetchNotif.php')
            ...
            function updateNotificationUI(notifications, unreadCount) {
                ...
                if (notifications.length > 0) {
                    ...
                    notifications.forEach(notification => {
                        html += `
                            <li class="dropdown-item ${notification.status === 'unread' ? 'unread-notification' : ''}" data-id="${notification.notification_id}">
                                <div class="d-flex justify-content-between">
                                    <span>${notification.message}</span>
                                    <small class="text-muted">${new Date(notification.created_at).toLocaleString('en-US', { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}</small>
                                </div>
                                <div class="d-flex justify-content-end mt-2">
                    ...
                    notificationList.innerHTML = '<li class="dropdown-item text-muted">No notifications found</li>';
                }
            }
